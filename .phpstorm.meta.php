...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/andndre/Code/bencana/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/andndre/Code/bencana/public/storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'home','dashboard','simulasi-bencana','penanggulangan-bencana',
'peta-bencana','ar-kamera','ar-markers.download','admin.index','admin.disasters.index',
'admin.disasters.create','admin.disasters.store','admin.disasters.edit','admin.disasters.update','admin.disasters.destroy',
'admin.disasters.steps.destroy','admin.locations','admin.locations.store','admin.locations.update','admin.locations.destroy',
'admin.markers.index','admin.markers.create','admin.markers.store','admin.markers.edit','admin.markers.update',
'admin.markers.destroy','profile.edit','profile.update','profile.destroy','register','login','password.request','password.email',
...
'admin._layout','admin.disasters.create','admin.disasters.edit','admin.disasters.index','admin.index',
'admin.layout','admin.locations.index','admin.markers.create','admin.markers.edit','admin.markers.index',
'ar-camera','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
...
'penanggulangan-bencana','peta-bencana','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','simulasi-bencana','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
